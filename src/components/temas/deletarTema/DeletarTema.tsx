...
function DeletarTema() {
    ...
    return (
        <div className="container w-1/3 mx-auto">
            <h1 className="text-4xl text-center my-4">Deleter Tema</h1>
            ...
            <div className="border flex flex-col rounded-2xl overflow-hidden justify-between">
                ...
                <div className="flex">
                    ...
                    <button className="text-slate-100 bg-indigo-400 hover:bg-indigo-600 w-full py-2" onClick={deletarTema}>
                        {isLoading ?
                            <RotatingLines
                                strokeColor="white"
                                strokeWidth="5"
